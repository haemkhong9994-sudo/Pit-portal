...
export const ICONS = {
  ...
  Slack: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="7" height="7" x="14" y="3" rx="1" /><rect width="7" height="7" x="3" y="14" rx="1" /><path d="M10 3a2 2 0 1 0-2 2h2V3Z" /><path d="M14 10a2 2 0 1 0 2 2v-2h-2Z" /><path d="M14 14a2 2 0 1 0 2 2v-2h-2Z" /><path d="M10 21a2 2 0 1 0 2-2v2h-2Z" /><path d="M3 10a2 2 0 1 0 2 2H3v-2Z" /><path d="M21 14a2 2 0 1 0-2-2h2v2Z" /></svg>
  ),
  LogOut: () => (
